...
def optimize_poisson_significance(y_true, y_pred, sample_weights, step=0.01, plot_output_path="nn_day1_significance_scan.png"):
    """
    ...
    plt.plot(thresholds, significances, color="purple", lw=2, label="Significance Profile")
    plt.axvline(
        x=optimal_threshold, 
        color="black", 
        linestyle=":", 
