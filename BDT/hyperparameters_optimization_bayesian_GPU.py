...
from sklearn.model_selection import train_test_split # Ajout pour la séparation des bases de données
...
# X_train : base d'entraînement (80%) | X_val : base de validation/test pour Optuna (20%)
...
plt.xticks(range(1, NB_ITERATIONS + 1, max(1, NB_ITERATIONS // 10))) # Ajustement automatique des graduations pour 100 itérations
